...
<template>
  <Field
    ...
    <input
      ...
      :readonly="readonly"
      :disabled="disabled"
      class="-mb-px h-12 rounded-b-lg border shadow-xs read-only:border-transparent read-only:bg-transparent read-only:px-0 read-only:shadow-none focus:z-20 focus:ring-3 read-only:focus:border-transparent read-only:focus:ring-transparent"
      :class="[
        errors.length == 0
